...
class SPAM(nn.Module):
    ...
    def forward(self, e, p):
        ...
        out_ep, _ = torch.topk(attention_matrix.view(b, -1), int(c * l * self.ratio), dim=1, largest=True, sorted=False)
